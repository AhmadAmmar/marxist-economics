...
The point is not that capitalism merely *trades} globally, but that accumulation is organised and
...
## A core distinction: trade as exchange, imperialism as enforced structure



Trade exists in many societies. **Imperialism} names something more specific: a durable structure in
...
power, and control over international rules.[LeninImperialism,PatnaikImperialism]
In other words: the world market is not a neutral meeting-point of equals. It is a terrain with built-in
...
Studies of global value-chain decompositions and branded commodity pricing (including classic electronics case-studies)[Smith2016,Hickel2022,DedrickKraemerLinden2010]
show a robust headline pattern: *the labour-cost share at the point of manufacture is typically a small fraction of the final realised price in core markets},
while downstream claims concentrated in the core (branding, design/IP, finance, and retail control) dominate the realised price.\footnote{**Precision note:}
different case-studies measure ``cost structure'' at different points in the chain (factory-gate cost, landed cost, wholesale, retail), and they may report
labour costs as a share of retail price or as a share of manufacturing cost. The headline pattern is robust across many documented decompositions---direct
manufacturing wages are typically a small fraction of final retail prices in branded commodities---but the exact percentage depends on commodity type, sourcing
regime, and the price point used as the denominator.}\footnote{**Conceptual note:}
a small wage share of final retail price is *not} itself a complete measure of exploitation (which depends on surplus relative to variable capital at the
point of production). It *is} a clear indicator of how the *realised} price of branded commodities is dominated by downstream claims (branding,
marketing, design/IP rents, finance, and retail markups) concentrated in the capitalist core. The argument here is therefore about *value appropriation
and surplus distribution} across the chain, not a one-to-one reading of wage share as the exploitation rate.}

A stylised summary:

[leftmargin=1.5em]
  - direct manufacturing wages are often less than \(5\)–\(10%\) of the retail price
  (*stylised across documented branded decompositions; the denominator and point-in-chain vary by case});
  - most of the surplus value is realised and appropriated in the centres of finance, marketing, and intellectual property; and
  - Northern states and firms control key chokepoints: technology, finance, logistics, and trade rules.[Smith2016,Hickel2022]


\noindent\textit{Concrete illustration.} For a South Asian supply-chain example that turns this into
hours, workdays, and units, see Example~ex:sialkot-piecewage (Sialkot
...
A growing portion of world-market power takes the form of **digital and intellectual-property enclosures}.
...
This is not a moral claim about individual consumers; it is a structural claim about ownership. Under capitalism,
...
The point is that once produced, the *reproduction} cost of many digital goods is low, so profitability depends heavily
on property rights, standards control, and platform power rather than proportional labour-time in each additional copy.}
...
*production is internationally dispersed, while command over realisation is centralised}. Where brands, platforms, and finance control market access and pricing,
...
From a Marxian point of view, value is created wherever living labour is expended, but the *distribution} of surplus value is shaped by power,
monopoly, and imperial structures. Unequal exchange is not simply about unfair prices; it is a mechanism for sustained transfer of value from South to North.\footnote{This framing
...
*divided} and *commanded} under imperial relations.}




## Debt, austerity, and structural adjustment: currency hierarchy and the external constraint
...
public employment.[StrugglePK_WorldPerspectives]
...
become strategies of discipline: wage repression, subsidy cuts, privatisation, and export push---not because of moral failure,
but because creditors and the world market enforce specific reproduction conditions.[PeetUnholyTrinity,IMFPakistan2023]
