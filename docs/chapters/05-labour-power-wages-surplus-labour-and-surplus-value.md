...
*do* literally steal wages (illegal non-payment). But Marx’s concept of exploitation
is deeper than that.
...
- therefore it cannot be abolished by moral appeals or contract reform alone, while the wage relation and private ownership of the main means of production remain.
...
!!! example "Example"
    ...
    - Of this, \$300 covers the value of used-up constant capital (beans, milk, cups, energy, machine depreciation) — this is $\constcap$.
    ...
    - Over the whole day, the rate of exploitation is $\exploitrate = 400\%$: for every \$1 paid in wages, \$4 of surplus-value is extracted.
...
- $\constcap = \$1{,}000{,}000$ in components, depreciation, logistics.
