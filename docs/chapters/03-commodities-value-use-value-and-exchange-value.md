...
Capitalism generalises commodity exchange so that money becomes the *universal equivalent*:
most goods and services are routinely bought and sold, and survival itself depends on access to money.
That is why under capitalism the typical question is not only *what* is produced, but
*what can be sold*, and for how much—including the selling of labour-power for wages.

When exchange-value is expressed in money, it appears as a **price**; later we return
to why prices do not always coincide with underlying values.

What interests Marx is: *what regulates these exchange ratios over the
