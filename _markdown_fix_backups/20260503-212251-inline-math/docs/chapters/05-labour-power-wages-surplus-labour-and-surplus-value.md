...
-   **Surplus (general):** output beyond what is immediately required to reproduce labour and social life at a given level (extra grain, stored food, extra cloth, extra labour-time, etc.). Surplus can exist in many kinds of society; the political question is *who controls it and on what basis* (see [Section 2.4](02-method-dialectical-and-historical-materialism.md#social-labour-surplus-and-the-historical-problem-of-control)).
...
[Section 5.3](05-labour-power-wages-surplus-labour-and-surplus-value.md#sec:why-surplus) established the baseline relation: 
$$
s = \mu\,T_S=\mu\,(T-T_N),
  \qquad
  v=\mu\,T_N,
...
!!! example "Example: Sialkot football stitching: piece-wage, implied time-wage, and the retail-price gap"
    ...
    We return to the same industry in Example [6.1](06-constant-and-variable-capital-circuits-of-capital.md#ex:sialkot-costtable), after introducing constant capital, variable capital, cost price, and producer-stage surplus.
...
For simplicity in these numerical examples, treat observed money prices and costs as proportional to underlying values. In reality, prices can systematically deviate from values through competition and the redistribution of surplus value via prices of production; see [Section 7.2](07-rate-of-profit-and-organic-composition-of-capital.md#sec:prices-production). Market power, state policy, and world-market conditions can generate further deviations around these regulating prices. [^8]
...
$$
e = \frac{s}{v}
  = \frac{$200{,}000}{$200{,}000} = 1 \;\Rightarrow\; e = 100%.
$$
...
First, this arithmetic treats money magnitudes as proportional to values for clarity. In reality, competition, productivity differentials, and market power generate systematic value--price divergences (see [Section 7.2](07-rate-of-profit-and-organic-composition-of-capital.md#competition-average-profit-and-prices-of-production)); we flag this here but abstract from those divergences in the worked numbers. [^10]
